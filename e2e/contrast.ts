 ...
 *    comparison, key-recovery cost and sampler-gap tables sit in `.table-scroll`
 *    wraps with `overflow-x: auto`, so at 380px most of their columns are
 *    clipped away. Content scrolled past the client box is not dimmed or partly
